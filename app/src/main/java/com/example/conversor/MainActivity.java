                ...
                if (response.isSuccessful()) {
                    ...
                    if (respostaServidor != null) {
                        ...
                        if(respostaServidor.isValid()) {
                            ...
                            Toast.makeText(MainActivity.this, "", Toast.LENGTH_SHORT).show();Toast.makeText(getApplicationContext(),"Insira unidade e valores válidos", Toast.LENGTH_SHORT).show();
                        }
